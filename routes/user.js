...
// Add to cart 
user_route.get('/cart',userAuth.isblock,userAuth.userChecking,userAuth.isblock,userController.loadcart)
user_route.post('/cart/:id',userAuth.isblock,userAuth.userChecking,userAuth.isblock,userController.Addcart)
user_route.post('/cart/quantityUpdate/:itemId',userAuth.isblock, userController.cartQuantityUpdate); 
user_route.post('/cartDelete/:id',userAuth.isblock,userController.cartDelete);
